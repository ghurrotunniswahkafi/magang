      ...
      <div class="card-section h-100">
        ...
        <div class="accordion-item">
            <label class="accordion-btn">
                <input type="radio" name="metode" value="atm" class="payment-select" style="margin-right:6px;">
                Via ATM
            </label>
        ...
        <div class="accordion-item">
            <label class="accordion-btn">
                <input type="radio" name="metode" value="mbanking" class="payment-select" style="margin-right:6px;">
                Via Mobile Banking
            </label>
        ...
        <div class="accordion-item">
            <label class="accordion-btn">
                <input type="radio" name="metode" value="cash" class="payment-select" style="margin-right:6px;">
                Via Cash
            </label>
        ...
        <div id="uploadSection">
          <form id="paymentForm" action="<?php echo e(route('booking.payment.upload', $pengunjung->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="metode_pembayaran" id="payment_method">
    
    
    <div id="uploadSection">
        <label>Upload Bukti</label>
        <input type="file" name="bukti_pembayaran" id="buktiFile">
    </div>
...
document.querySelectorAll(".payment-select").forEach(radio => {
    ...
    radio.addEventListener("change", function () {
        ...
        if (selected === "atm" || selected === "mbanking") {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\sym\Downloads\Jenar\pbtcmasmansur-main\resources\views/booking/payment.blade.php ENDPATH**/ ?>