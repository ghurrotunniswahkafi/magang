    ...
    <div class="col-lg-7">
      <div class="card-section h-100">
        ...
        <div id="cashButton" class="mt-4">
            <a href="<?php echo e(route('booking.success', $pengunjung->id)); ?>"
...
document.querySelectorAll(".payment-select").forEach(radio => {
    ...
    radio.addEventListener("change", function () {
        ...
        // Tutup semua konten instruksi dulu
        contents.forEach(c => c.classList.remove("show"));

        // Buka instruksi sesuai radio
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Jenar/pbtcmasmansur-main/resources/views/booking/payment.blade.php ENDPATH**/ ?>