...
<form action="<?php echo e(route('booking.corporate.store')); ?>" method="POST" enctype="multipart/form-data">
  ...
  <input type="hidden" name="jumlah_kamar_request" value="<?php echo e($jumlah_kamar ?? 1); ?>">
      ...
      <div class="mb-3">
        ...
        <select name="kode_kamar[]" multiple class="form-control" size="6">
          <?php $__currentLoopData = $kamars; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($k->kode_kamar); ?>" <?php echo e($k->kode_kamar == $selectedRoom->kode_kamar ? 'selected' : ''); ?>>
              <?php echo e($k->kode_kamar); ?> - <?php echo e($k->jenis_kamar); ?> (<?php echo e(number_format($k->harga,0,',','.')); ?>/malam)
            </option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        <small class="text-muted">Tekan Ctrl (Cmd di Mac) untuk pilih beberapa kamar</small>
        <?php if(isset($jumlah_kamar) && $jumlah_kamar > 1): ?>
            <div class="text-primary mt-1 small">
                <i class="fas fa-info-circle"></i> Anda meminta <strong><?php echo e($jumlah_kamar); ?> kamar</strong> di halaman depan. Silakan pilih kamar tambahannya di daftar di atas.
            </div>
        <?php endif; ?>
      </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Joki\Jenar\pbtcmasmansur-main\resources\views/booking/corporate.blade.php ENDPATH**/ ?>