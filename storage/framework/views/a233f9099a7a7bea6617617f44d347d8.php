        ...
        <?php else: ?>
          ...
          <td style="min-width:160px">
            <?php if($isCheckedOut): ?>
              ...
              <div style="font-size:12px;color:#7a0b0b;margin-top:6px"><?php echo e($p->check_out); ?></div>
            <?php else: ?>
...
<tr class="checked-out-row">
    ...
    <td><strong style="color:#0b6623">
        <?php echo e($displayTotal !== null ? 'Rp '.number_format($displayTotal,0,',','.') : '-'); ?>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Jenar/pbtcmasmansur-main/resources/views/admin/pengunjung.blade.php ENDPATH**/ ?>