          ...
          <td>
            <div style="display:flex;gap:6px;flex-wrap:wrap">
              <form action="<?php echo e(route('pengunjung.approve', $p->id)); ?>" method="POST" style="margin:0">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn-confirm" <?php echo e(!$p->bukti_pembayaran ? 'disabled title=Butuh bukti pembayaran' : ''); ?>>
                  Konfirmasi
                </button>
              </form>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Jenar/pbtcmasmansur-main/resources/views/admin/pembayaran_konfirmasi.blade.php ENDPATH**/ ?>